...
// GetCF returns the data associated with the cf & key from the database given this transaction.
...
// GetForUpdateCF queries the data associated with the cf & key and puts an exclusive lock on the key from the database given this transaction.
...
// DeleteCF removes the data associated with the cf & key from the transaction.
...
// NewIteratorCF returns an Iterator over the database with provided cf
